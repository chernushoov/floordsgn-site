...
- `LIBRARY_ARCHITECTURE.md` — Knowledge Library: `articles/*` + blog consolidated into `/library`; two entries (4 roles · 8 pillars), card grid, reading-paths, HE gated until native review.
